...
5. ホットスワップソケットのはんだ付け
6. リセットスイッチのはんだ付け
7. トッププレートの端にスイッチを取り付ける
8. (オプション) ミドルプレート (上) とトッププレートの間にシリコンシートを挟む
9. トッププレートにすべてのスイッチを取り付ける
10. ボトムプレートを取り付ける
11. トッププレート側からネジ止めする
...
REMAP か [QMK](https://github.com/tamago324/qmk_firmware/tree/nowt36/keyboards/nowt36) を使用して、ファームウェアを書き込みます。
